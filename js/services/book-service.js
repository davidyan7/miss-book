...
import { axiosService } from './ans-service-axios.js';

var booksJson = [{
        "id": "OXeMG8wNskc",
        "title": "metus hendrerit",
        "subtitle": "mi est eros convallis auctor arcu dapibus himenaeos placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse ",
        "authors": [
            "Barbara Cartland"
        ],
        "publishedDate": 1999,
        "description": "placerat placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse",
        "pageCount": 713,
        "categories": [
            "Computers",
            "Hack"
...
function addBook(book) {
    ...
    storageService.post(BOOK_KEY, currBook)
...
function fixGoogleBook(book) {
    const currBook = book.volumeInfo
    currBook.id = book.id
    ...
    if (!book.volumeInfo.description) book.volumeInfo.description = 'We not have a description...'
    currBook.description = book.volumeInfo.description
    currBook.listPrice = {}
    currBook.listPrice.amount = 150
    currBook.listPrice.isOnSale = true
    currBook.listPrice.currencyCode = 'ILS'
    currBook.thumbnail = book.volumeInfo.imageLinks.smallThumbnail
    return currBook
}
...
//     gCars.unshift(car);
//     utilService.saveToStorage(CARS_KEY, gCars);
// }
